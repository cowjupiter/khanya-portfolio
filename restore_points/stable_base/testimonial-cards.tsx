    ...
    >
      ...
      <div className="flex flex-col items-center">
        <img
          ...
          className="pointer-events-none h-24 w-24 sm:h-28 sm:w-28 rounded-full border-2 border-white/40 dark:border-white/10 shadow-lg object-cover"
        />
      </div>
...
const testimonials: Testimonial[] = [
  {
    ...
    author: "Sarah Mitchell — Founder @ Peace Haven on Lagoon"
  },
  {
    id: 2,
    ...
    author: "Thabo Khumalo — Creative Director @ Isithelo Sekhethelo"
  },
  {
    id: 3,
    ...
    author: "Naledi Dlamini — Operations Lead @ Monoshez Holdings"
  },
  {
    id: 4,
    ...
    author: "Johan Botha — Managing Director @ Salmax"
  }
];
    ...
    <section className="bg-main px-6 py-20 sm:py-24 md:py-32 w-full flex flex-col items-center justify-center overflow-hidden transition-colors duration-300 relative">
      <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-center gap-12 sm:gap-16 lg:gap-24 xl:gap-32 relative z-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-md gap-4 sm:gap-6">
          ...
          <h2 className="hero-heading font-black uppercase leading-none tracking-tight text-[clamp(2rem,6vw,80px)]">
            What they say
          </h2>
